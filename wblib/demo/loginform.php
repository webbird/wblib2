...
$form->setForm('example_login_form');
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de">
    <head>
        ...
        <title>wbForms Demo - Sample login form</title>
        <link rel="stylesheet" href="index.css" type="text/css" media="screen" />
        <?php echo $form->getHeaders(); ?>
    </head>
    <body>
      <div class="header"><h1>wbForms Demo - Sample login form</h1></div>
      <div class="content">
        This is a sample login form. There's no validation in this case.<br /><br />
        Please note: No data will be sent by sending this form, you will only get a dump of the $_REQUEST array.<br /><br />
